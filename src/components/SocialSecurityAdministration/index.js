...
export const SocialSecurityAdministration = () => {
	const socialSecurityAdministrationRef = useRef(null)

	useEffect(() => {
		scrollReveal({
			component: socialSecurityAdministrationRef.current,
			direction: 'right',
			time: 900
		})
	}, [])
	...
	return (
		<div
			className='mt-5'
			ref={socialSecurityAdministrationRef}
			id='socialSecurityAdministration'
		>
			<div className='container'>
				<div className='row'>
					<h1 className='mt-5'>
						Asesorias y administracion en seguridad social
					</h1>
					<p>
